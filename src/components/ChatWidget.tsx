  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content:
        "Hi! I'm CareerBot, your AI career advisor. I can help you find scholarships, internships, fellowships, and other opportunities. What are you interested in?",
      sender: "bot",
      timestamp: new Date(),
    },
  ]);
    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          className="bg-primary hover:shadow-glow transition-all duration-300 rounded-full p-4 shadow-lg animate-float"
          size="lg"
        >
  ...
  return (
    ...
    >
      <Card className="h-full flex flex-col shadow-glow border-0 bg-gradient-card">
        <CardHeader className="pb-3 bg-gradient-primary shadow text-primary-glow rounded-t-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="text-primary-glow hover:bg-white/20 p-1 h-auto"
              >
