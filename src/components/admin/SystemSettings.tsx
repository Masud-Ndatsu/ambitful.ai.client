...
import { Settings, Users, Globe, Bell, Database, Shield, Plus, Edit, Trash2, TestTube } from "lucide-react";
import { Separator } from "@/components/ui/separator";

const adminUsers = [
  { id: 1, name: "John Admin", email: "john@admin.com", role: "Administrator", status: "active", lastLogin: "2024-01-26" },
  { id: 2, name: "Sarah Manager", email: "sarah@admin.com", role: "Content Manager", status: "active", lastLogin: "2024-01-25" },
  { id: 3, name: "Mike Editor", email: "mike@admin.com", role: "Editor", status: "inactive", lastLogin: "2024-01-20" },
  { id: 4, name: "Lisa Reviewer", email: "lisa@admin.com", role: "Reviewer", status: "active", lastLogin: "2024-01-26" },
];

const scrapingSources = [
  { id: 1, name: "Microsoft Careers", url: "https://careers.microsoft.com", status: "active", lastCrawl: "2024-01-26", success: true },
  { id: 2, name: "Google Opportunities", url: "https://buildyourfuture.withgoogle.com", status: "active", lastCrawl: "2024-01-26", success: true },
  { id: 3, name: "UN Opportunities", url: "https://www.un.org/en/opportunities", status: "active", lastCrawl: "2024-01-25", success: false },
  { id: 4, name: "World Bank Jobs", url: "https://www.worldbank.org/en/about/careers", status: "paused", lastCrawl: "2024-01-20", success: true },
];

const roles = [
  { name: "Administrator", permissions: ["All permissions"] },
  { name: "Content Manager", permissions: ["Manage opportunities", "Review AI drafts", "View analytics"] },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Configure platform settings and manage access control</p>
      </div>
        ...
        <TabsContent value="crawling" className="space-y-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Manage websites for automatic content crawling</CardDescription>
              </div>
              <Dialog>
                <DialogTrigger asChild>
                  <Button>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>Add a new website to crawl for opportunities</DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="source-name">Source Name</Label>
                      <Input id="source-name" placeholder="e.g., Microsoft Careers" />
                    </div>
                    <div>
                      <Label htmlFor="source-url">Website URL</Label>
                      <Input id="source-url" placeholder="https://example.com" />
                    </div>
                    <div>
                ...
                <TableBody>
                  {scrapingSources.map((source) => (
                    <TableRow key={source.id}>
                      ...
                      <TableCell className="text-sm text-muted-foreground">{source.url}</TableCell>
                      <TableCell>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure automatic content crawling settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <Label htmlFor="auto-crawl">Automatic Crawling</Label>
                  <p className="text-sm text-muted-foreground">Enable automatic content discovery</p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Notify when new AI drafts need review</p>
                  </div>
                  <Switch 
                    id="draft-alerts" 
                    checked={notificationSettings.draftAlerts}
                    onCheckedChange={(checked) => 
                      setNotificationSettings(prev => ({ ...prev, draftAlerts: checked }))
                    }
                  />
                </div>
                <Separator />
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Notify about system errors and failed crawls</p>
                  </div>
                  <Switch 
                    id="error-alerts" 
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="email-notifications" placeholder="admin@example.com" />
                  </div>
                  <div>
        ...
        <TabsContent value="privacy" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure data retention and privacy compliance settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Enable user behavior analytics</p>
                  </div>
                  <Switch 
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked) => 
                      setPrivacySettings(prev => ({ ...prev, userDataExport: checked }))
                    }
                  />
                </div>
              </div>
