...
import { Calendar, MapPin, ExternalLink, Share2, CheckCircle, DollarSign, Users } from "lucide-react";
...
const relatedOpportunities = [
  {
    ...
    type: "Scholarship",
    description: "A technology-focused scholarship for computer science students.",
  ...
  },
  {
    ...
    type: "Fellowship",
    description: "Research fellowship for undergraduate students in STEM fields.",
    deadline: "May 1, 2024",
    location: "Various",
    amount: "$3,500",
    link: "#"
  ...
  const handleShare = async (platform: string) => {
    ...
    switch (platform) {
      ...
      case 'twitter':
        ...
        break;
      case 'email':
        window.open(`mailto:?subject=${encodeURIComponent(opportunity.title)}&body=${encodeURIComponent(shareText + ' ' + shareUrl)}`);
        break;
      case 'copy':
    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-gradient-card">
        ...
        <div className="space-y-6">
          ...
          {/* Share Buttons */}
          <div>
            <h3 className="text-lg font-semibold mb-3">Share This Opportunity</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">Similar Opportunities</h3>
            <div className="grid md:grid-cols-2 gap-4">
              {relatedOpportunities.map((relatedOpp) => (
                <OpportunityCard
                  key={relatedOpp.id}
